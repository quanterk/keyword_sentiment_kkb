...
# similar = get_related_words(['说','指出','报道','提出','表示','称'], model)
# joblib.dump(similar, 'keyword_similar.pkl')

similar = joblib.load('keyword_similar.pkl')
# sentence="国务院总理李克强调研上海外高桥提出，支持上海积极探索新机制。"
