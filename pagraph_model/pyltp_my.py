...
class HIT():
    ...
    def posttagger(self):
        ...
        # postagger.load('/Users/ceil/PycharmProjects/personal/pyltp/ltp/ltp_data_model/pos.model')  # 加载模型
        postagger.load('/home/student/project-01/ltp_data/pos.model')  # 服务器路径
    ...
    def ner(self):
        ...
        # recognizer.load("/Users/ceil/PycharmProjects/personal/pyltp/ltp/ltp_data_model/ner.model")  # 加载模型
        recognizer.load('/home/student/project-01/ltp_data/ner.model')  # 服务器路径
    ...
    def parse(self):
        parser = Parser()  # 初始化实例
        # parser.load('/Users/ceil/PycharmProjects/personal/pyltp/ltp/ltp_data_model/parser.model')  # 加载模型
        parser.load('/home/student/project-01/ltp_data/parser.model')  # 服务器路径
